# -*- coding: utf-8 -*-
"""
Created on Sun Jun 19 16:34:02 2022
...
import numpy as np
import re
filepath = 'C:/Users/shaurya/Downloads/rat99-11.csp2'
problem=''
values =[]
val1dict = dict()
val2dict = dict()
...
df1.to_string('./rat_df1.txt',index = False)
df2.to_string('./rat_df2.txt',index = False)