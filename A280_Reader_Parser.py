# -*- coding: utf-8 -*-
"""
Created on Sat Jun 18 22:04:40 2022
purpose : to view and present the content of a280.tsp file.
...
val2dict = dict()
#input file path
filepath = 'C:/Users/shaurya/Downloads/Compressed/TSPLIB-python-parser-master/TSPLIB-python-parser-master/a280.tsp'


#open and read content return as list of values
...
#repairs the list remove blanks e.g. ['1',"",'2'] becomes [1,2]
...
df.to_string('./A280.txt',index = False)
print(df)
