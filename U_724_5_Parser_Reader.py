# -*- coding: utf-8 -*-
"""
Created on Sun Jun 19 16:39:19 2022
...
import numpy as np
import re
filepath = 'C:/Users/shaurya/Downloads/u724-5.csp2'
problem=''
values =[]
val1dict = dict()
val2dict = dict()
...
df1.to_string('./u274_5_11_df1.txt',index = False)
df2.to_string('./u274_5_11_df2.txt',index = False)